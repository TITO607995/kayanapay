...
export default function GooglePlay() {
  ...
  useEffect(() => {
    fetch("http://192.168.100.17:8000/api/topup/products?brand=GOOGLE PLAY INDONESIA")
      .then((res) => res.json())
      .then((data) => {
    ...
    <main className="min-h-screen font-sans pb-36 lg:pb-20 bg-slate-50 relative">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="flex items-center gap-4 mb-8 bg-white p-5 rounded-2xl shadow-sm border border-slate-200">
          <div className="w-16 h-16 bg-blue-50 text-blue-600 border border-blue-100 rounded-xl flex items-center justify-center text-3xl">▶️</div>
          <div>
            <h2 className="text-2xl font-black text-slate-800 uppercase">Google Play ID</h2>
            <p className="text-sm text-slate-500">Voucher Digital | Kode instan dikirim ke invoice.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className={`space-y-6 ${activeTab === "transaksi" ? "block animate-fade-in" : "hidden lg:block"}`}>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                ...
                <div className="w-full md:w-2/3">
                  <input 
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition font-medium" 
                  />
                </div>
                <p className="text-xs text-slate-400 mt-2">Masukkan nomor HP aktif. Kode voucher akan muncul di detail pesanan.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                ...
                {isLoading ? (
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {products.sort((a, b) => a.price_sell - b.price_sell).map((item) => (
                      <button 
                      ...
                      >
                        <p className="font-bold text-sm text-slate-800">{item.product_name.replace("GOOGLE PLAY INDONESIA - ", "")}</p>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                ...
                />
                <p className="text-xs text-slate-400 mt-2">Notifikasi pesanan dan Kode Voucher akan dikirimkan melalui WhatsApp.</p>
              </div>
            ...
            <div className={`${activeTab === "keterangan" ? "block animate-fade-in" : "hidden"} lg:hidden bg-white p-6 rounded-2xl shadow-sm border border-slate-200`}>
              <h3 className="font-black text-lg text-slate-800 mb-4 border-l-4 border-blue-500 pl-3 uppercase">
                Deskripsi Google Play ID
              </h3>
              <p className="text-slate-600 text-sm leading-relaxed mb-6">
                Beli kode Voucher Google Play Region Indonesia dengan harga termurah. Kode akan dikirimkan secara instan langsung ke invoice atau WhatsApp Anda.
              </p>
              
              <h4 className="text-slate-800 font-bold text-sm mb-3">Cara Membeli Voucher :</h4>
              <ol className="list-decimal ml-4 space-y-2 text-slate-600 text-sm font-medium">
                <li>Pilih tab <b>Transaksi</b>.</li>
                <li>Masukkan <b>Nomor HP</b> Anda sebagai tujuan pengiriman.</li>
                ...
                <li>Kode Voucher akan muncul di halaman sukses.</li>
              </ol>
            </div>
          ...
          <div className="hidden lg:block lg:col-span-1 relative">
            <div className="space-y-6 h-full">
              ...
              {/* KOTAK DESKRIPSI (Nangkring di Atas Rincian Pesanan) */}
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                ...
                <ol className="list-decimal ml-4 space-y-2 text-slate-600 text-sm font-medium">
                  ...
                  <li>Kode Voucher akan dikirimkan ke WhatsApp Anda.</li>
                </ol>
              </div>
              ...
              <div className="sticky top-24 bg-white rounded-2xl p-6 border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-blue-50 rounded-xl flex items-center justify-center text-2xl border border-blue-100">▶️</div>
                  <div>
                    <h4 className="text-slate-800 font-bold text-sm">Google Play ID</h4>
                    <p className="text-slate-500 text-xs mt-0.5">
                      {selectedDenom ? selectedDenom.product_name.replace("GOOGLE PLAY INDONESIA - ", "") : "Belum memilih voucher"}
                    </p>
                  </div>
                </div>
