...
function GooglePlay() {
  ...
  useEffect(() => {
    fetch("https://kayanamart.my.id/api/topup/products?brand=GOOGLE PLAY INDONESIA")
      .then((res) => res.json())
      .then((data) => {
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                ...
                <div className="w-full md:w-2/3">
                  <input 
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition font-medium" 
                  />
                </div>
...
export default function GooglePlayContent() {
  return (
