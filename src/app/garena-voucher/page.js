...
export default function GarenaVoucher() {
  ...
  useEffect(() => {
    fetch("http://192.168.100.17:8000/api/topup/products?brand=GARENA")
      .then((res) => res.json())
      .then((data) => {
    ...
    <main className="min-h-screen font-sans pb-36 lg:pb-20 bg-slate-50 relative">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="flex items-center gap-4 mb-8 bg-white p-5 rounded-2xl shadow-sm border border-slate-200">
          ...
          <div>
            <h2 className="text-2xl font-black text-slate-800 uppercase">Garena</h2>
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                {isLoading ? (
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {products.sort((a, b) => a.price_sell - b.price_sell).map((item) => (
                      ...
                      >
                        <p className="font-bold text-sm text-slate-800">{item.product_name.replace("GARENA - ", "")}</p>
            ...
            <div className={`${activeTab === "keterangan" ? "block animate-fade-in" : "hidden"} lg:hidden bg-white p-6 rounded-2xl shadow-sm border border-slate-200`}>
              <h3 className="font-black text-lg text-slate-800 mb-4 border-l-4 border-blue-500 pl-3 uppercase">
                Deskripsi Garena Shell
              </h3>
              <p className="text-slate-600 text-sm leading-relaxed mb-6">
                Beli kode Voucher Garena Shell dengan harga termurah. Kode akan dikirimkan secara instan langsung ke invoice atau WhatsApp Anda.
              </p>
            ...
            <div className="space-y-6 h-full">
              ...
              <div className="sticky top-24 bg-white rounded-2xl p-6 border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h4 className="text-slate-800 font-bold text-sm">Garena</h4>
                    <p className="text-slate-500 text-xs mt-0.5">
                      {selectedDenom ? selectedDenom.product_name.replace("GARENA - ", "") : "Belum memilih voucher"}
                    </p>
                  </div>
                </div>
