...
export default function DaftarPage() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const res = await fetch("https://kayanamart.my.id/api/member/register", {
        method: "POST",
  ...
  const handleGoogleLogin = () => {
    // Kita arahkan browser langsung ke backend, biar backend lempar ke Google
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-slate-100 p-8">
          ...
          <div className="flex items-center my-6 gap-4">
            ...
            <span className="text-sm text-slate-400 font-medium">Atau daftar dengan</span>
            <div className="flex-1 h-px bg-slate-200"></div>
          </div>
