    ...
    if (userId.length >= 5 && zoneId.length >= 3) {
      ...
      const timer = setTimeout(async () => {
        try {
          ...
          if (data.status === "success") {
            setNickname(`✅ Halo, ${data.data.nickname}`); 
          } else {
    ...
    <main className="min-h-screen bg-slate-50 text-slate-800 font-sans pb-36 lg:pb-20 relative">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="flex items-center gap-4 mb-8 bg-white p-5 rounded-2xl shadow-sm border border-slate-200">
          ...
          <div>
            <h2 className="text-2xl font-black text-slate-800 uppercase">Mobile Legends</h2>
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="h-6 px-1 mt-1">
                    ...
                    {!isChecking && nickname && (
                      <p className={`text-sm font-bold tracking-wide ${nickname.includes("❌") ? "text-red-500" : "text-emerald-600"}`}>
                        {nickname}
                      </p>
                    )}
                  </div>
            ...
            <div className={`${activeTab === "keterangan" ? "block animate-fade-in" : "hidden"} lg:hidden bg-white p-6 rounded-2xl shadow-sm border border-slate-200`}>
              ...
              <p className="text-slate-600 text-sm leading-relaxed mb-6">
                Top up diamond Mobile Legends (MLBB) harga paling murah, aman, cepat, dan terpercaya hanya di KAYANAPAY. Beli diamond ML untuk gacha skin epic, legend, hingga collector impianmu!
              </p>
            ...
            <div className="space-y-6 h-full">
              ...
              <div className="sticky top-24 bg-white rounded-2xl p-6 border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h4 className="text-slate-800 font-bold text-sm">Mobile Legends</h4>
