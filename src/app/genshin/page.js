...
function GenshinImpact() {
  ...
  useEffect(() => {
    fetch("https://kayanamart.my.id/api/topup/products?brand=GENSHIN IMPACT")
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    if (products.length > 0 && skuFlashSale) {
      ...
      if (targetProduct) {
        ...
        setTimeout(() => {
          document.getElementById("step-nominal")?.scrollIntoView({
            behavior: "smooth",
            block: "center",
          });
        }, 100);
  ...
  const koinDiskon = useKoin
    ? Math.min(koinSaldo, Math.max(0, baseTotal))
    : 0;
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="flex items-center gap-4 mb-8 bg-white p-5 rounded-2xl shadow-sm border border-slate-200">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Hoyoverse | Proses cepat dan aman.</p>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-xs text-slate-400 mt-2">
                    Masukkan UID dan pilih Server yang sesuai dengan akun Anda.
                  </p>
                </div>
              </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        {products
                          .filter(
                            (item) =>
                              !item.product_name.toLowerCase().includes("blessing") &&
                              !item.product_name.toLowerCase().includes("welkin") &&
                              !item.product_name.toLowerCase().includes("cek")
                          )
                          .sort((a, b) => a.price_sell - b.price_sell)
                          .map((item) => (
                            <button
            ...
            <div className={`${activeTab === "keterangan" ? "block animate-fade-in" : "hidden"} lg:hidden bg-white p-6 rounded-2xl shadow-sm border border-slate-200`}>
              ...
              <p className="text-slate-600 text-sm leading-relaxed mb-6">
                Top up Genesis Crystal dan Blessing of the Welkin Moon harga paling murah, aman, cepat, dan terpercaya hanya di KAYANAPAY.
              </p>
              ...
              <ol className="list-decimal ml-4 space-y-2 text-slate-600 text-sm font-medium">
                ...
                <li>Masukkan Kode Promo (opsional) dan Detail Kontak.</li>
...
export default function GenshinImpactContent() {
  return (
    <Suspense
      fallback={
